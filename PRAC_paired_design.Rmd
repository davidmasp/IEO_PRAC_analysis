...
By looking at the distributions of the tables, we observe that the values are equally distributed. As expected there is no batch effect. 

_*One of the possible batch effects would be the plate distribution, but in relation of the type variable they are equally analysed.???????? NO ENTENC RES! RESCRIURE*_
