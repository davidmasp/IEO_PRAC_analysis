...
Having the samples / genes filtered and ready, we proceed with the differential expression analysis. 

# Differential Expression Analysis

Initially, we observe the differental expression with a multiple linear regression test, having as a cutoff a FDR of 0.01 .
