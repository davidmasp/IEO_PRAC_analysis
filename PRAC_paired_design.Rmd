...
We explore the data to check whether there exists some kind of batch effect or an undesired source of variation.
...
sampleDists <- dist( t( assay(prac.se.dupl) ) )
head(sampleDists)
class(sampleDists)
...
number.id <- c("7737","7745","7738","7211","7747","6356","6362","5769","7123") 
...
```{r Cllustering 2, echo = FALSE, fig.height=10, fig.width=10}
