...
par(mfrow=c(2,2))
volcanoplot(fit, coef=2, highlight=7, fit$genes$symbol, main="Base Model", las=1, cex = 0.1 )
volcanoplot(fit2, coef=2, highlight=7, fit4$genes$symbol, main="Model voom", las=1, cex = 0.1)
volcanoplot(fit3, coef=2, highlight=7, fit4$genes$symbol, main="Model voom + TSS", las=1, cex = 0.1)
volcanoplot(fit4, coef=2, highlight=7, fit4$genes$symbol, main="Model voom + TSS + SV", las=1, cex = 0.1)
```
