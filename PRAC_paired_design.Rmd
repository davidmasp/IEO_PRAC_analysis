...
number.id <- c("7737","7745","7738","7211","7747") 
...
text(tt[tt$adj.P.Val < 1e-18, "logFC"], -log10(tt[tt$adj.P.Val < 1e-18, "P.Value"]), labels = rownames(tt[tt$adj.P.Val < 1e-18,]), cex=0.7, pos=4)
...
boxplot(GSexpr[DEgs[9], ] ~ prac.se.GSEA$type, main=DEgs[9], las=1, cex.axis=2)
```
