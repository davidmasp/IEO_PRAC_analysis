...
\begin{table*}[!h]
\centering
\caption{\bf Gene Ontology enriched terms. Columns present the GO identificator (GOBPID), the associated pvalue, odds ratio magnitude of the result, the Expected count of random hits (ExpCount), actual count (Count), size of the gene set (Size), a brief description (Term) and the hit genes. }
