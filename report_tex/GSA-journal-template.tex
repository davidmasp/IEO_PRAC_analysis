...
\author[$\ast$,$\dagger$,1]{David Mas-Ponte}
...
\marginmark
\firstpagefootnote
\correspondingauthoraffiliation{Any of the authors can be used as correspondence contact. author and email for the corresponding author. The corresponding author should be marked with a `1' in the author list, as shown in the example.}
\vspace{-11pt}%
...
\begin{itemize}
\item 74\% of all tumors being assignable to one of seven molecular classes based on distinct oncogenic drivers:
...
\item 25\% of the prostate cancers had a presumed actionable lesion in the PI3K or MAPK signaling pathways, and DNA repair genes were inactivated in 19\%.
\end{itemize}
