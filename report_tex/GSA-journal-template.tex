...
The software used was R version 3.3.0 "Supposedly Educational" \cite{R} on x86_64-pc-linux-gnu and _______MAC. Main packages where download and installed through Bioconductor version 3.3 (BiocInstaller 1.22.2)\cite{bioconductor}.
