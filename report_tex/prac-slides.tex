...
\begin{frame}{Gene Set Expression Analysis}{ Enrichment approach (GSEA)}
  \centering 
    \includegraphics[width=0.75\textwidth,height=0.35\textheight,keepaspectratio]{genesets1.eps} \\
    \includegraphics[width=0.75\textwidth,height=0.35\textheight,keepaspectratio]{genesets2.eps}
\end{frame}
...
\begin{center}
    \includegraphics[width=.5\textwidth,height=0.5\textheight,keepaspectratio]{venn}
    \vskip
