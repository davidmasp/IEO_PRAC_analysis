...
The Top5 Selected Gene through significance level:
\begin{itemize}
...
The AP002884.2 transcript compromises 2 genes SDHD and BCO2 related with the succinate dehydrogenase with vitamin A biosynthesis.
\end{block}
\end{frame}
