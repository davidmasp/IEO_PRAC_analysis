...
```{r hirechical clustering, fig.align='center', fig.width=10, fig.cap='Hirechical clustering of the prac.se.sub dataset', fig.height=8}
logCPM <- cpm(prac.dge.unique.filtlib, log=TRUE, prior.count=3)
d <- as.dist(1-cor(logCPM, method="spearman"))
sampleClustering <- hclust(d)
batch <- as.integer(factor(tss))
head(matrix(c(batch,tss),byrow=TRUE,nrow = 2))
