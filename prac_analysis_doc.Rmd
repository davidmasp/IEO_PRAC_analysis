...
par(mfrow=c(14, 6), mar=c(4, 5, 3, 1))
...
prac.dge.unique.pruned <- prac.dge.unique.filtlib[, !rownames(prac.dge.unique.filtlib$samples) %in% c("TCGA.HC.7737.11A.02R.2118.07","TCGA.HC.7747.11A.01R.2118.07","TCGA.HC.8258.11A.01R.2263.07")]
...
```{r sva to check batch effect, fig.align='center'}
