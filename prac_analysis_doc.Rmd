...
##MA-plots
###Tumor MA-plot
```{r maPlotsTumor, fig.align="center",fig.height=40, fig.width=12, dpi=100, echo=FALSE, fig.cap="Figure S4: MA-plots of the tumor samples."}
par(mfrow=c(22, 6), mar=c(4, 5, 3, 1))
...
```
###Normal MA-plot
```{r maPlotsNormal, fig.align="center", fig.height=40, fig.width=12, dpi=100, echo=FALSE, fig.cap="Figure S4: MA-plots of the tumor samples."}
par(mfrow=c(22, 6), mar=c(4, 5, 3, 1))
