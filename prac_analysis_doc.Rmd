...
The batch effect occurs when there is any non-biological variable that accounts for the variability between samples. This source of sample variability might obscure the analysis of variation and comparison between samples.

First of all, check for batch effect in TSS variable (Tissue Source Site).
