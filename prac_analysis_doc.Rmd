...
```
We observe 549 studied clinical variables. By seeing the values, we observe that most of them have NA values. Some of the variables are related directly with prostate cancer, like the gleason score, the official measurement of the development of the adenocarcinoma. 
