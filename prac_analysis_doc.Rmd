...
As we can see in fig. 11 and 12, the overall clustering of the samples is a bit better than before. Those 7 normal samples were disturbing the clustering by type (normal tissue vs tumor tissue).  
...
The histogram in fig. 13 presents a peak in the 0.0-0.1 region, indicating a high presence of DE genes. The distribution of the other values is quite uniform and low in comparison with the 0.1-0.0 values. We apply the SVA modification to observe the changes in the distribution: 
...
However, it seems that the number of genes fullfilling the p-values restriction are few in fig. 15 (5546) than in fig. 14 (7145).
